...
public class Level_02_Apply_BasePage_Part_III extends BasePage {
	...
	public void TC_02_LoginWithInvalidEmail() {
		 sendKeyToElement(driver, "//input[@id='email']", "1234@12345");
		 sendKeyToElement(driver, "//input[@id='pass']", "1234567");
		 clickToElement(driver, "//button[@id='send2']");
	...
	public void TC_03_LoginWithIncorrectEmail() {
		 sendKeyToElement(driver, "//input[@id='email']", "lethucnt@gmail.com");
		 sendKeyToElement(driver, "//input[@id='pass']", "123456");
		 clickToElement(driver, "//button[@id='send2']");
		
		Assert.assertEquals( getElementText(driver, "//li[@class='error-msg']//ul/li/span"), "Invalid login or password.");
		
	}
	
	@Test
	public void TC_04_LoginWithInvalidPassword() {
		 sendKeyToElement(driver, "//input[@id='email']", "lethucntt1@gmail.com");
	...
	public void TC_06_LoginWithValidEmailAndPassword() {
		...
		Assert.assertTrue( isElementDisplayed(driver, "//h3[text()='Contact Information']"));
	}
